...
const js = programmingLanguage[0] + [4]
//console.log(js)
...
//console.log(harryPotterAuthor.substring(0, 5))
...
const realBestMovie = ["realBestMovie"]
realBestMovie[0] = "Moonlight"
//console.log(bestMovie + realBestMovie)
...
newName = `${capitalizedParts[0]} ${capitalizedParts[1]} `;
